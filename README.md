...
🌦 Formally, I'm a scientist for machine learning, improving global weather forecasts with AI at the [ECMWF](https://dramsch.net/ecmwf)/[@ECMWF](https://github.com/ecmwf), a 2022 fellow of the [Software Sustainability Institute](https://dramsch.net/ssi) for AI4Science, and a Co-chair of the Working Group Modelling for the [ITU Global Initiative](https://www.itu.int/en/ITU-T/extcoop/ai4resilience/Pages/default.aspx) on Resilience to Natural Hazards through AI Solutions.

💻 I list all of my projects at [dramsch.net/projects](https://dramsch.net/projects).

🏳‍🌈 My pronouns are ([they / them](https://dramsch.net/pronouns))
...
- [😤 If I shenan once, I will shenanigan](https://archive.late.email/archive/if-i-shenan-once-i-will-shenanigan/)
- [🐍 Python 3.14 releases this year, making it π-thon](https://archive.late.email/archive/python-314-releases-this-year-making-it-pi-thon/)
...
1. 🗣 Commented on [#347](https://github.com/JesperDramsch/python-deadlines/pull/347#issuecomment-4363569007) in [JesperDramsch/python-deadlines](https://github.com/JesperDramsch/python-deadlines)
2. 🗣 Commented on [#346](https://github.com/JesperDramsch/python-deadlines/issues/346#issuecomment-4344770751) in [JesperDramsch/python-deadlines](https://github.com/JesperDramsch/python-deadlines)
3. 🗣 Commented on [#2](https://github.com/JesperDramsch/pogo-filter-workshop/pull/2#issuecomment-4343921267) in [JesperDramsch/pogo-filter-workshop](https://github.com/JesperDramsch/pogo-filter-workshop)
4. ❌ Closed PR [#2](https://github.com/JesperDramsch/pogo-filter-workshop/pull/2) in [JesperDramsch/pogo-filter-workshop](https://github.com/JesperDramsch/pogo-filter-workshop)
5. 🔒 Closed issue [#312](https://github.com/JesperDramsch/python-deadlines/issues/312) in [JesperDramsch/python-deadlines](https://github.com/JesperDramsch/python-deadlines)
